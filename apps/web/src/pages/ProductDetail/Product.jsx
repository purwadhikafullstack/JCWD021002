      ...
      >
        ...
        <Flex alignItems="center" gap={2}>
          <Link to="/cart" >
            ...
            <Icon as={HiOutlineShoppingCart} boxSize={7} 
          _hover={{ color: 'gray.600', opacity: 0.9 }}
            ...
            {cartTotalQuantity > 0 ? (
              <Flex
                ...
                p={1.5}
              >
                <Text fontSize="10pt">{cartTotalQuantity}</Text>
              </Flex>
            ) : null}
            </Flex>
          </Link>
        ...
        <VStack width={size == '500px' ? '100%' : '50vw'}>
          ...
          >
            <Text fontSize="x-large" fontWeight="bold" color="tomato">
              {formatPriceToIDR(data?.Product?.price)}
            </Text>
            <Text fontWeight="bold">{data?.Product?.name}</Text>
            <Text>
              {data?.Product?.massProduct} {data?.Product?.Mass?.name} /{' '}
              {data?.Product?.Packaging?.name}{' '}
            </Text>
          </Box>
          <Box
            mt="10px"
            ...
            >
              <Flex flexWrap="wrap" gap="20px">
                ...
                <Text ml="40px" fontWeight="bold">
                  Total : {formatPriceToIDR(quantity * data?.Product?.price)}
                </Text>
                <Button
            ...
            >
              <Flex alignItems="center" gap={2}>
                ...
                <Box>
                  ...
                  <Text fontSize="sm">Stock: {data?.stock}</Text>
                </Box>
              </Flex>
              <Divider />
              <Flex
