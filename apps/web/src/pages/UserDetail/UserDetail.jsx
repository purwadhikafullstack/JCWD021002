          ...
          >
            ...
            <Flex gap="10px" mb="20px">
              <Box width="100%">
                ...
                <Text color={data?.role_idrole == 1 ? 'green' : 'red'}>
                  {data?.role_idrole == 1 ? (
                    <IconCircleCheckFilled />
                  ) : (
                    <IconCircleXFilled />
              ...
              <Box pt="27px" width="100%">
                ...
                <Text color={data?.role_idrole == 2 ? 'green' : 'red'}>
                  {data?.role_idrole == 2 ? (
                    <IconCircleCheckFilled />
                  ) : (
                    <IconCircleXFilled />
              ...
              <Box pt="27px" width="100%">
                ...
                <Text color={data?.role_idrole == 3 ? 'green' : 'red'}>
                  {data?.role_idrole == 3 ? (
                    <IconCircleCheckFilled />
                  ) : (
                    <IconCircleXFilled />
            ...
            >
              ...
              <Box pt="27px" width="100%">
                ...
                <Text>
                  ...
                  {data?.Store?.City?.Province?.province}
                </Text>
              </Box>
            </Flex>
          </Box>
