  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        ...
        }/products/product-lists?page=${page}&pageSize=${pageSize}&sortField=${sortField}&sortOrder=${sortOrder}&categoryId=${categoryId}&productName=${productName}&storeId=${
          user?.store_idstore ? user?.store_idstore : storeId
          ...
          >
            ...
            <ModalContent>
              ...
              <ModalFooter>
                ...
                <Button
                  colorScheme="red"
                  onClick={() => setEditToStockModalIsOpen(false)}
                >
                  Cancel
                </Button>
              </ModalFooter>
